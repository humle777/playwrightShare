...
test('test', async ({ page }) => {
    ...
    await page.getByPlaceholder('Пароль').fill('yevhenii.davydenko@lasoft.org');
    await page.getByRole('button', { name: 'Увійти' }).click();
    await page.getByPlaceholder('Email').click();
    await page.getByText('× Невірний email або пароль').click();
    await page.getByPlaceholder('Email').click();
    await page.getByPlaceholder('Email').fill('yevhenii.davydenko@lasoft.org');
    await page.locator('body').click();
    await page.getByPlaceholder('Пароль').click();
    await page.getByPlaceholder('Пароль').fill('dkmc7fJ1');
    await page.getByRole('button', { name: 'Увійти' }).click();
