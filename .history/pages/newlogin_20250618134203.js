...
export class NewLoginPage {
    ...
    constructor(page) {
        ...
        this.passwordInput = page.locator("input");
...
await this.page.waitForTimeout(1000); // Ждем 1 секунду, чтобы убедиться, что поле ввода пароля активно
