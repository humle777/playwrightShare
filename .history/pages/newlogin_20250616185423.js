...
export class NewLoginPage {
 ...
 // НОВЫЕ МЕТОДЫ ДЛЯ ПРОВЕРКИ ЗНАЧЕНИЯ ПОЛЯ
  ...
  async verifyPasswordIsHiddenByValue(expectedPassword) {
    await expect.soft(this.passwordInput).toHaveAttribute('type', 'password'); // Часто этот атрибут все-таки остается
  }
